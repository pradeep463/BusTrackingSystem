...
public class DriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // login = findViewById(R.id.btn_driverLogin) ;
        mContext = this;
...
//rigister button
       ...
       /* rigister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this,RigisterActivity.class);
                startActivity(i);
                finish();
            }
        });*/
    ...
    public static void openNewActivity(){
        ...
        Intent i = new Intent(mContext.getApplicationContext(),DriverLocationActivity.class);
    ...
    public void loginBtn(View view) {
        ...
        if(TextUtils.isEmpty(getEmail) || TextUtils.isEmpty(getPassword)){
            ...
            DriverBackground bg = new DriverBackground((View.OnClickListener) this);
